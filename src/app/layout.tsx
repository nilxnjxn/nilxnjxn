...
export const metadata = {
  ...
  description: "Official platform for Nilxnjxn aka Nila. Upcoming Hip-hop wave from Assam, India. Debut EP SHADES dropping 2026. LIVE FREE, BE YOU.",
  keywords: ["Nilxnjxn", "Nila", "Assam Hip-hop", "Indian Rap", "SHADES EP", "Independent Music", "Direct Distribution"],
  ...
  openGraph: {
    ...
    description: "Official artist platform. Explore the sound of Nila. Debut EP SHADES coming 2026.",
    siteName: "NILXNJXN",
  },
  twitter: {
    card: "summary_large_image",
    title: "NILXNJXN | Hip-hop Artist from Assam",
    description: "Official platform for Nilxnjxn aka Nila. Upcoming Hip-hop wave from Assam, India.",
...
const jsonLd = {
  ...
  "name": "Nilxnjxn",
  "alternateName": "Nila",
  "description": "Upcoming Hip-hop Artist from Assam, India specializing in cinematic soundscapes and seasonal mood exploration.",
  "url": "https://nilxnjxn.com",
